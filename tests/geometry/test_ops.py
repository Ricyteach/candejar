...
def test_iter_oriented_line_pt_idx_hard1(splitter, four_points_to_orient):
    idxs_list = list(ops.iter_oriented_line_pt_idx(four_points_to_orient, splitter))
    assert idxs_list==[3,2]

def test_iter_oriented_line_pt_idx_hard2(rev_splitter, four_points_to_orient):
